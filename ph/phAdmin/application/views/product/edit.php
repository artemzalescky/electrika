...
<div class="well">
    <form action="<?= $ph->system_url('/product/update/' . $catalog['id'] . '/' . $product['id'])?>" method="post" class="form-horizontal">
        <fieldset>
            <legend> Редактирование товара <span class="underlined"><?= $realProduct['name'] ?></span> </legend>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea id="inputDescription" name="product[description]" class="form-control exploded-textarea"><?= $product['description'] ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="inputPriority" class="col-lg-2 control-label"> Приоритет </label>
                <div class="col-lg-10">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" value="<?= !empty($product['measure']) ? $product['measure'] : 'шт.' ?>"
                           name="product[measure]" placeholder="Единица измерения" id="inputMeasure"
                           class="form-control" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
